...
import { CreateTask, DeleteTask , CreateSubtask ,showTaskAndSubtasks , deleteSubtaskFromTask, UpdateTask ,UpdateSubtask} from "../controllers/controllers";
...
taskRouter.put("/updatesubtask/:taskId/:subtaskId",UpdateSubtask);
